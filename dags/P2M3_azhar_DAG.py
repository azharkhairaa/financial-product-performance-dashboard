...
def fetch_data_from_postgresql():
    ...
    # save to csv
    df.to_csv("/opt/airflow/csv/P2M3_azhar_data_raw.csv", index=False)
...
def clean_data():
    ...
    '''
    # read csv
    df = pd.read_csv("/opt/airflow/csv/P2M3_azhar_data_raw.csv")
    ...
    # save to csv
    df.to_csv("/opt/airflow/csv/P2M3_azhar_data_clean.csv", index=False)
...
def post_to_elasticsearch():
    ...
    '''
    # read csv
    df = pd.read_csv("/opt/airflow/csv/P2M3_azhar_data_clean.csv")
